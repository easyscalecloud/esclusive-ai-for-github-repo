# -*- coding: utf-8 -*-
#
# esclusive_ai_for_github_repo documentation build configuration file, created by
...
import esclusive_ai_for_github_repo as package
...
# Add data for Jinja2
try:
    from esclusive_ai_for_github_repo.docs import doc_data
except:
    doc_data = dict()
